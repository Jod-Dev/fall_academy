...
function FeaturesHomeFour() {
  return (
    <>
      <section
        className="iyf-features-area-2 iyf-features-area-5 pt-90 pb-100"
        id="features"
      >
          ...
          <div className="row mt-30 align-items-center">
            <div className="col-lg-6">
              <div className="iyf-features-boxes ">
                <div className="iyf-features-box-item iyf-features-box-5-item">
                  <h4 className="title">Well Integrated</h4>
                  <p>The bee's knees chancer car boot absolutely.</p>
                </div>
                <div className="iyf-features-box-item item-2 iyf-features-box-5-item">
                  <h4 className="title">Clean and modern Design</h4>
                  <p>The bee's knees chancer car boot absolutely.</p>
                </div>
                <div className="iyf-features-box-item item-3 iyf-features-box-5-item">
