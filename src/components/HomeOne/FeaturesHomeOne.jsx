...
function FeaturesHomeOne({ className }) {
  ...
  return (
    <section className={`iyf-features-area pt-100 ${className}`} id="features">
            ...
            <div className="tab-content" id="v-pills-tabContent">
              ...
              >
                <div className="row align-items-center">
                  ...
                  <div className="col-lg-6">
                    <div
                      className="iyf-features-content wow animated fadeInRight"
                      data-wow-duration="2000ms"
              ...
              >
                <div className="row align-items-center">
                  ...
                  <div className="col-lg-6">
                    <div
                      className="iyf-features-content animated fadeInRight"
                      data-wow-duration="2000ms"
                      data-wow-delay="600ms"
                    >
                      <span>Custom Reacyions</span>
