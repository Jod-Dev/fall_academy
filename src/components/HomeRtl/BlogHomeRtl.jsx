...
function BlogHomeRtl({ className }) {
  return (
    <>
      <section className={`iyf-blog-area pt-90 pb-95 ${className || ""}`}>
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="iyf-section-title text-center">
                <h3 className="iyf-title">أحدث مشاركات المدونة</h3>
          ...
          <div className="row">
            <div className="col-lg-4 col-md-6">
              <div
                className="iyf-blog-item text-right mt-30 wow animated fadeInUp"
