...
function AboutHomeTwo() {
  return (
    <>
      <section className="iyf-about-area mb-100">
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div
                className="iyf-about-box wow animated fadeInUp"
              ...
              >
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    <div className="iyf-about-content">
                      <span>Marketing</span>
                      <h3 className="title">
                        Make a lasting impression with iyf.
                      </h3>
                      <p>
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <div className="iyf-about-academies mt-30">
                          <div className="icon">
