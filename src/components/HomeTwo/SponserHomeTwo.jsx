...
function SponserHomeTwo({ className }) {
  return (
    <>
      <section className={`iyf-sponser-area pb-100 ${className}`}>
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="iyf-section-title text-center">
                <h3 className="iyf-title">
                  iyf works best with <br />
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="iyf-sponser-box d-flex justify-content-center">
              ...
              <div className="iyf-sponser-box item-2 d-flex justify-content-center">
                <div className="sponser-item">
