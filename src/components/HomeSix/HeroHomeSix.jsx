...
function HeroHomeSix() {
  return (
    <>
      <section className="iyf-hero-area iyf-hero-6-area">
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="iyf-hero-thumb-6">
                <div
            ...
            <div className="col-lg-6">
              <div className="iyf-hero-content iyf-hero-content-6">
                <span>Welcome To Creative App.</span>
                <h1 className="iyf-title">Get started with iyf Template.</h1>
                <p>
