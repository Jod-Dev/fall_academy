...
function FooterHomeEight() {
  return (
    <>
      <section className="iyf-footer-area iyf-footer-about-area iyf-footer-8-area">
            ...
            <div className="col-lg-3 col-md-6">
              <div className="footer-widget-info">
                ...
                <ul>
                  <li>
                    <a href="#">
                      <i className="fal fa-envelope"></i> support@iyf.com
                    </a>
                  </li>
                  <li>
                    <a href="#">
                  ...
                  <li>
                    <a href="#">
                      <i className="fal fa-map-marker-alt"></i> 442 Belle Terre
            ...
            <div className="col-lg-12">
              ...
              >
                ...
                <div className="copyright-text">
                  <p>Copyright © 2021 iyf. All rights reserved.</p>
                </div>
              </div>
            </div>
          </div>
