...
function BlogHomeEight() {
  return (
    <>
      <section className="iyf-blog-3-area iyf-blog-8-area pt-90 pb-100">
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="iyf-blog-item-3 iyf-blog-item-8 mt-30">
                <div className="thumb">
                  <img src={blog4} alt="" />
                </div>
        ...
        <div className="iyf-blog-8-shape-1">
          <img src={shape5} alt="" />
        </div>
        <div className="iyf-blog-8-shape-2">
          <img src={shape12} alt="" />
        </div>
      </section>
    </>
